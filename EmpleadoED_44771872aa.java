package empleadoED_44654545aa;

import java.util.*;


public class EmpleadoED_44771872AA {

    static final double FACTOR_HORA_EXTRA = 1.2;
    private String nombreCompleto, dni;
    private double salarioBasePorHora = 10.56;

    public EmpleadoED_44771872AA(String nombreCompleto, String dni) {
    ...
    public static void main(String[] args) {
        ...
        EmpleadoED_44771872AA emp = new EmpleadoED_44771872AA("SERGIO BADAL", "44654545X");
        int horasExtra = 2;
